...
<div class="container">
    <div class="row">        
        <div class="col-sm-12">
            ...
            <h4><span class="greenSpan"><%trans('/front/articles/show.created')%></span> {{vm.article.user_id == vm.currentUserId ? vm.you : vm.byTheUser + vm.userArticle.profile.last_name}}</h4>
            ...
            <h4><span class="greenSpan"><%trans('/front/articles/show.email')%>:</span> {{vm.userArticle.email}}</h4>
