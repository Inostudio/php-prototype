(function () {
    ...
    angular
       ...
       function GetArticlesAndCategories($resource, lim){
            return $resource('/' + lang +  '/articles/articles-and-categories', {limit: lim}, {
                query: {method:'GET', params:{}, isArray:true}
            });
        };
        
        function GetArticleMore($resource, lim, off){
            return $resource('/' + lang +  '/articles/more-articles', {limit: lim, offset: off}, {
                query: {method:'GET', params:{}, isArray:true}
            });
        }
        
        function GetSearchResult($resource, lim, off, cat, phr){
            return $resource('/' + lang +  '/articles/search-results', {limit: lim, offset: off, category: cat, phrase: phr}, {
                query: {method:'GET', params:{}, isArray:true}
            });
        }
        
        function ShowArticle($resource, $articleId){
            return $resource('/' + lang +  '/articles/show-article', {artId: $articleId}, {
                query: {method:'GET', params:{}, isArray:true}
            });
        } 
        
        function RemoveArticle($resource, $removeId){
            return $resource('/' + lang +  '/articles/remove-article', {artId: $removeId}, {
                query: {method:'POST', params:{}, isArray:true}
            });
        }
        
        function GetCategory($resource){
            return $resource('/' + lang +  '/articles/category', {}, {
                query: {method:'GET', params:{}, isArray:true}
            });
        } 
        
        function CreateArticle($resource, $title, $category, $body){
            return $resource('/' + lang +  '/articles/create-article', {articleTitle: $title, articleCategory: $category, articleBody: $body}, {
                query: {method:'POST', params:{}, isArray:true}
            });
        }   

        function EditArticle($resource, $title, $body, $category, $id){
            return $resource('/' + lang +  '/articles/edit-article', {title: $title, body: $body, category: $category, id: $id}, {
                query: {method:'POST', params:{}, isArray:true}
            });
        }   
})();
